...
> 完整方案与实现开源：模块代码 [github.com/DeguiLiu/nginx-rtc-module](https://github.com/DeguiLiu/nginx-rtc-module)（纯 C，MIT），部署与示例 [github.com/DeguiLiu/nginx-rtc-example](https://github.com/DeguiLiu/nginx-rtc-example)。
>
...
| 转码/封装 | AAC→Opus（FFmpeg+libopus）、NALU→RTP（RFC 6184） | 音频转码 + RTP 打包 |
...
更多实现细节（状态机、GOP 环结构、shm 布局、单测清单）见模块源码 [github.com/DeguiLiu/nginx-rtc-module](https://github.com/DeguiLiu/nginx-rtc-module) 与部署示例 [github.com/DeguiLiu/nginx-rtc-example](https://github.com/DeguiLiu/nginx-rtc-example)。
