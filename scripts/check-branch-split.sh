...
#
# Keep in sync with nginx-rtc-module/scripts/check-branch-split.sh: the body is
# the same, only the allow list differs. This repo does not pass
# --forbid-win32-tokens: its Windows guide mentions MinGW on purpose.
